/*buffer_blocking : MPI_Send and MPI_Recv

 Description:
   "buffer_blocking" and "buffer_non_blocking" demonstrate the difference between blocking
   and non-blocking point-to-point communication.
          Example buffer_blocking: MPI_Send/MPI_Recv (blocking)
          Example buffer_non_blocking: MPI_Isend/MPI_Irecv (non-blocking)
   ...
   "buffer_non_blocking" show how to use non-blocking communication (MPI_Isend and
